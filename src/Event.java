...
try {  
            event.setEventID(dateFormat.parse(dateString));  
    ...
    private void setEventID(Date date) {
    ...
    private void organizeEvent() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'organizeEvent'");
    }
